...
export default function PlayQuiz({ DataQuiz, UserMob, ChaperID }) {
    ...
    const CreateAttempOrder = async () => {
        ...
        const data = await fetch("/api/TestCourse/CreateAttempOrder", {
            method: "POST",
            headers: {
    ...
    const SendOPSDATA = async (SecCount, result) => {
        ...
        const data = await fetch("/api/TestCourse/TestSubmit", {
            method: "POST",
            headers: {
                'Content-type': 'application/json'
            },
            ...
            .then((TestSubmitReq) => {
                ...
                if (TestSubmitReq.statuswhat == true) {
                    setTimeout(function () {
                        router.push(`/CourseTestResultApp/${TestSubmitReq.datagot}`)
    ...
    const LoadallQues = async () => {
        ...
        const data = await fetch("/api/TestCourse/AllQues_test", {
            method: "POST",
            headers: {
                'Content-type': 'application/json'
            },
