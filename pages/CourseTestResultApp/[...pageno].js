...
import AttemptResultTab from '../../components/CourseTest/AttemptResultTab'
...
const Slug = (props) => {
    ...
    const GetData = async () => {
        const TestID = { ID }
        const data = fetch("/api/TestCourse/GetAttemptResult", {
            method: "POST",
            headers: {
                    ...
                    <div>
                        ...
                        <div className={styles.TimeBoxResult} style={{ backgroundColor: '#dcf9fd' }}>
                            <div>
                                ...
                                <span style={{ marginLeft: '5px', marginTop: '-10px' }}># {SendText}<span style={{ fontWeight: 'bold' }}>  Status : {Retdata.statusText}</span> </span>
                            </div>
                            <div>
                        ...
                        <div className={styles.ResultBox}>
                            ...
                            <AttemptResultTab ID={ID} QTitle={Retdata.Title} />
                        </div>
                    </div>
                }
